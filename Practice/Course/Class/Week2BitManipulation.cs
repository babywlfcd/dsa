...
{
    public class Week2BitManipulation
    {
        /// <summary>
        /// Convert a POSITIVE number from base 10 to base x
        /// 
        ...
        /// Steps:
        /// 1. for even number (in case of base 2), mumbers that ate multiple of x in general,
        ///    we will have the issue that the end is zero and in revers that zero will be lost
        ...
        /// <summary>
        /// Add two binary numbers when input is string
        /// Solution:
        ...
        public string AddBinary(string a, string b)
        {
            ...
            /*
             * This expression converts the character to its corresponding integer value. 
             * In C#, characters are represented by their ASCII values. 
             * The ASCII value of '0' is 48, and the ASCII value of '1' is 49. 
             * By subtracting '0' (which is 48) from a[i], you get the integer value of the character:
             * •	If a[i] is '0', then '0' - '0' equals 48 - 48, which is 0.
             * •	If a[i] is '1', then '1' - '0' equals 49 - 48, which is 1.
        ...
        /// <summary>
        /// The solution in class provide comparison without need
        /// </summary>
        /// <param name="n"></param>
        /// <returns></returns>
        public int LastSignificantBit(int n)
        {
            /*
             * if(n % 1 == 0)
             *      return true
        ...
        /// <summary>
        /// Check even number bit.
        /// Thi is equivalent to the LastSignificantBit
        /// Usual condition for a number n is n % 2 == 0 for even number and n % 2 == 1 for odd number
        /// We can use the bitwise operator to check the last significant bit instead of using the modulo operator
        /// </summary>
        /// <param name="n"></param>
        /// <returns></returns>
        public string CheckEvenNunberBit(int n)
        {
            if ((n & 1) == 0)
                return "Even";
            return "Odd";
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public bool IsIthBitSetRightShift(int num, int i)
        {
            return ((num >> i) & 1) != 0;
        }
